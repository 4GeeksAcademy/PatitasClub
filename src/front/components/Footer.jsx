  ...
  <>
    ...
    <footer className="footer py-4 text-center">
      <div className="d-flex flex-wrap justify-content-center align-items-center gap-4 py-3">
        <a
          href="https://www.tiktok.com/@patitasclub_petshop"
          target="_blank"
        ...
        <a
          href="https://www.instagram.com/patitasclubpetshop/"
          target="_blank"
          rel="noopener noreferrer"
        >
        ...
        <a
          href="mailto:petshoppatitasclub@gmail.com?subject=Consulta%20desde%20la%20web&body=Hola%2C%20quisiera%20saber%20m%C3%A1s%20sobre%20sus%20productos."
        >
          <i style={{ color: "#3c6ca8" }} className="fa-solid fa-envelope fa-2x"></i>
        </a>
      </div>
      <p style={{ color: "#3c6ca8" }} className="mb-0 fs-5">
        ¡Contáctanos!
      </p>
